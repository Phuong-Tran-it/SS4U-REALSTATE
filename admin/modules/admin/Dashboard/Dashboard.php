...
<html lang="en">
   <?php require_once __DIR__. "/../../../autoload/autoload.php"; 
      ...
      $check = " SELECT * FROM transaction LIMIT 8";
      $checked = $db->fetchsql($check);
      $noti =" SELECT * FROM transaction WHERE status = '0' ";
      $notied = $db->fetchsql($noti);
      ?>
   <head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
            ...
            <ul class="navbar-nav navbar-nav-right">
               ...
               <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                     <a class="dropdown-item" href="/SS4UREALSTATE/admin/modules/transaction/index.php">
 ...
 setInterval(function(){ 
  load_unseen_notification();; 
               ...
               <li class="nav-item dropdown d-none d-xl-inline-block">
                  ...
                  <span class="profile-text">Xin Chào, <?php echo $_SESSION['name_Admin'] ?> !</span>
                  <img class="img-xs rounded-circle" src="<?php echo uploads() ?>product/<?php echo $_SESSION['avatar'] ?>" alt="Profile image">
                  </a>
                  <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                     ...
                     <a class="dropdown-item" href="/SS4UREALSTATE/admin/modules/admin/edit.php?id=<?php echo $_SESSION['name_IDadmin']?>">
                     Thay Đổi Thông Tin
                     </a>
                     <a class="dropdown-item">
                     Check Inbox
                     </a>
                     <a class="dropdown-item" href="/SS4UREALSTATE/admin/modules/admin/Dashboard/Thoat_Admin.php">
                     Thoát
                     </a>
                  </div>
               </li>
               ...
               <div class="nav-link">
                  <div class="user-wrapper">
                     <div class="profile-image">
                        <img src="<?php echo uploads() ?>product/<?php echo $_SESSION['avatar'] ?>" alt="profile image">
                     </div>
                     <div class="text-wrapper">
                        <p class="profile-name"><?php echo $_SESSION['name_Admin']?></p>
                        <div>
                           <small class="designation text-muted">
                           <?php echo $_SESSION['level']== 1 ? ' Cộng Tác Viên' : ' Quản Trị Viên' ?>
                           </small>
            ...
            <li class="nav-item">
               ...
               <div class="collapse" id="ui-basic">
                  <ul class="nav flex-column sub-menu">
                     <li class="nav-item">
                        <a class="nav-link" href="/SS4UREALSTATE/admin/modules/admin/index.php">Quản Trị Viên</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="/SS4UREALSTATE/admin/modules/category/index.php">Chủ Đầu Tư</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="/SS4UREALSTATE/admin/modules/product/index.php">Sản Phẩm</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="/SS4UREALSTATE/admin/modules/User/index.php">Người Dùng</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="/SS4UREALSTATE/admin/modules/transaction/index.php">Quản Lý Hóa Đơn</a>
                     </li>
                  </ul>
               </div>
            </li>
                        ...
                        <div class="clearfix">
                           ...
                           <div class="float-right">
                              ...
                              <div class="fluid-container">
                                 <h3 class="font-weight-medium text-right mb-0" ><a href="/SS4UREALSTATE/admin/modules/product/index.php"><?php echo count($product) ?></a></h3>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="card-body">
                        <div class="clearfix">
                           ...
                           <div class="float-right">
                              ...
                              <div class="fluid-container">
                                 <h3 class="font-weight-medium text-right mb-0"><a href="/SS4UREALSTATE/admin/modules/transaction/index.php"><?php echo count($book) ?></a></h3>
                              </div>
                           </div>
                        </div>
                        <p class="text-muted mt-3 mb-0" >
                  ...
                  <div class="card card-statistics">
                     <div class="card-body">
                        <div class="clearfix">
                           ...
                           <div class="float-right">
                              <p class="mb-0 text-right">Đã Bán</p>
                              <div class="fluid-container">
                     ...
                     <div class="card-body">
                        <div class="clearfix">
                           ...
                           <div class="float-right">
                              ...
                              <div class="fluid-container">
                                 <h3 class="font-weight-medium text-right mb-0"><a href="/SS4UREALSTATE/admin/modules/User/index.php"><?php echo count($User) ?></a></h3>
                              </div>
                           </div>
                        </div>
                        <p class="text-muted mt-3 mb-0">
