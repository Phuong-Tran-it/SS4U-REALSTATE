            ...
            <div class="panel panel-primary">
               ...
               <div class="panel-body" >
                  ...
                  <div class="form-group col-md-3">
                     ...
                     <input type="text" class="form-control" id="inputEmail4" placeholder="" name="HOUSE_DETAIL_CODE">
            ...
            <div class="panel-body">
                  ...
                  <div class="panel panel-primary">
                     ...
                     <div class="panel-body">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="inputAddress" placeholder="" name="NP_FLOORS">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="inputAddress" placeholder="" name="NP_DT_LODAT">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="inputAddress2" placeholder="" name="NP_DT_SAN">
                  ...
                  <div class="panel panel-primary">
                     ...
                     <div class="panel-body">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="inputAddress" placeholder="" name="DT_TIMTUONG">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" id="inputAddress" placeholder="" name="DT_THONGTHUY">
                  ...
                  <div class="panel panel-primary">
                     ...
                     <div class="panel-body">
                        <div class="form-group col-md-6">
                           ...
                           <input type="text" class="form-control" id="inputAddress" placeholder="" name="SL_PHONG">
                        ...
                        <div class="form-group col-md-6">
                           ...
                           <input type="text" class="form-control" id="inputAddress" placeholder="" name="DT_LUNG">
                        ...
                        <div class="form-group">
                           ...
                           <input type="datetime-local" class="form-control" id="inputAddress" placeholder="" name="OPENING_DAY">
                        </div>
                        <br>
                        <div class="form-group">
                           <label for="inputAddress">Ngày Hoàn Thành</label>
                           <input type="datetime-local" class="form-control" id="inputAddress" placeholder="" name="FINAL_DAY">
                        </div>
                        <div class="form-group">
               ...
               <div class="form-row">
                  <div class="form-group col-md-6" >
                     ...
                     <input type="number" class="form-control" id="inputAddress" placeholder="000.000.000" name="price">
               ...
               <div class="form-row-primary">
                  <div class="form-group-">
                     ...
                     <textarea class="form-control" id="exampleFormControlTextarea1" name="content" rows="4"></textarea>
