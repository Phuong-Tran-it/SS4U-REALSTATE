    ...
    <body>
                        ...
                        <div class="col-md-7 col-sm-8 remove-left">
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="active"><a href="home.html" class="page-scroll">Trang Chủ</a></li>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
            ...
            <div class="carousel-inner">
                <div class="item active"> <img src="images/Home/building.png" style="width:100%; height: 720px" alt="First slide">
                ...
                <div class="item"> <img src="images/Home/villavip.png" style="width:100%; height: 720px" alt="First slide">
                    <div class="carousel-caption">
                        <div class="contact-form">
                            <input type="text" placeholder="Tên">
                            <input type="text" placeholder="Email">
                ...
                <div class="item"> <img src="images/Home/banner3.png" style="width:100%; height: 720px" alt="First slide">
                    <div class="carousel-caption">
                        <div class="contact-form">
                            <input type="text" placeholder="Tên">
                            <input type="text" placeholder="Email">
                ...
                <div class="row">
                    <div class="finder-block-inner">
                        <form>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12 scrollReveal sr-scaleDown sr-delay-1">
                                <select><option>Khoảng Giá</option></select>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 scrollReveal sr-scaleDown sr-delay-2">
                                <select><option>Khu Vực</option></select>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 scrollReveal sr-scaleDown sr-delay-3">
                                <select><option>Phòng Ngủ</option></select>
                            </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 scrollReveal sr-scaleDown sr-delay-4">
                                <select><option>Phòng Tắm</option></select>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12 grid remove-right-padd">
                        <figure class="effect-marley scrollReveal sr-bottom sr-delay-1">
                            <img alt="img11" src="images/Home/Image1.png">
                            <figcaption>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 grid remove-left-padd">
                        <figure class="effect-marley scrollReveal sr-bottom sr-delay-2">
                            <img alt="img11" src="images/Home/Image2.png">
                            <figcaption>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 grid remove-right-padd">
                        <figure class="effect-marley scrollReveal sr-bottom sr-delay-1">
                            <img alt="img11" src="images/Home/Image3.png">
                            <figcaption>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 grid remove-left-padd">
                        <figure class="effect-marley scrollReveal sr-bottom sr-delay-2">
                            <img alt="img11" src="images/Home/Image4.png" style="width:566px; height: 257px">
                            <figcaption>
        ...
        <section class="gallery-block">
            <div class="container">
                ...
                <ul class="bxslider">
                    <li><img src="images/Home/Image6.png"/></li>
                    <li><img src="images/Home/Image7.png"/></li>
                    <li><img src="images/Home/Image8.png"/></li>
                    <li><img src="images/Home/Image9.png"/></li>
                    <li><img src="images/Home/Image10.png"/></li>
        ...
        <footer>
            <div class="container">
                <div class="row footer-block-main">
                    <div class="col-sm-3 col-xs-12">
                        <div class="footer-block"><h4>Đường Dẫn</h4>
                            <ul class="list-unstyled">
                                ...
                                <li><a href="agents.html">Người Quản Lý</a></li>
                    ...
                    <div class="col-sm-3 col-xs-12">
                        <div class="footer-block"><h4>Mạng Xã Hội</h4>
